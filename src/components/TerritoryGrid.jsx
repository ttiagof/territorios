      ...
      <div className="flex-1 overflow-y-auto px-3 sm:px-6 pt-4 pb-6 overscroll-contain">
        ...
        <div className="flex gap-3 mb-4 sm:mb-6">
          ...
          <button
            ...
            className="w-12 h-12 shrink-0 bg-accent-600 hover:bg-accent-700 rounded-full flex items-center justify-center active:scale-95 transition-all focus:outline-none focus:ring-2 focus:ring-accent-500 focus:ring-offset-2 dark:focus:ring-offset-gray-900 shadow-sm cursor-pointer"
