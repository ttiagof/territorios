      ...
      >
        ...
        {showEditForm ? (
          ...
          <>
            ...
            <div className="flex items-center justify-between px-4 sm:px-6 pt-4 sm:pt-6 pb-4 border-b border-gray-100 shrink-0">
              <div className="flex items-center gap-2.5">
                ...
                <span className="text-base font-semibold text-gray-900">Editar território</span>
              </div>
              <button
                onClick={onClose}
                className="w-7 h-7 flex items-center justify-center rounded-full bg-[#f0f0f0] hover:bg-gray-200 text-gray-500 transition-colors cursor-pointer"
            ...
            <div className="flex-1 px-4 sm:px-6 py-4 sm:py-5 space-y-4 overflow-y-auto overscroll-contain">
              <div className="grid grid-cols-2 gap-3">
                <div>
                  ...
                  <input
                    ...
                    className="w-full bg-[#f0f0f0] rounded-xl px-3 py-2.5 text-sm border-0 focus:outline-none focus:ring-2 focus:ring-accent-400"
                  />
                </div>
                <div>
              ...
              <div>
                ...
                <textarea
                  ...
                  rows={3}
                  className="w-full bg-[#f0f0f0] rounded-xl px-3 py-2.5 text-sm border-0 resize-none focus:outline-none focus:ring-2 focus:ring-accent-400"
                />
              </div>
            ...
            <div className="px-4 sm:px-6 pb-safe sm:pb-6 pt-4 border-t border-gray-100 flex flex-col sm:flex-row gap-2 sm:justify-end shrink-0">
              ...
              <button
                onClick={cancelEdit}
                className="w-full sm:w-auto text-sm px-5 py-3 sm:py-2.5 rounded-xl bg-[#f0f0f0] text-gray-600 hover:bg-gray-200 font-medium transition-colors cursor-pointer"
              >
                Cancelar
              </button>
            </div>
          ...
          <>
            ...
            {/* Footer */}
            <div className="px-4 sm:px-6 pb-safe sm:pb-6 pt-4 border-t border-gray-100 flex items-center gap-2 shrink-0">
